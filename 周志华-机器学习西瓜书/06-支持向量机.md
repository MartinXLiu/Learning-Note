...
![PointToHyperPlane](https://github.com/MartinXLiu/Learning-Note/blob/8047af55ffe1b0cdaad439b29e15fd7e1a332a38/%E5%91%A8%E5%BF%97%E5%8D%8E-%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0%E8%A5%BF%E7%93%9C%E4%B9%A6/graph/PointToHyperPlane.png?raw=ture)

这里画一个图便于理解。图中蓝色线即超平面，对应直线方程 $\mathbf{w}^T\mathbf{x}+b=0$。投影向量 $\mathbf{w}$垂直于超平面，点 $x$ 对应向量 $\mathbf{x}$，过点 $x$ 作超平面的垂线，交点 $x_0$ 对应向量 $\mathbf{x_0}$。假设**由点 $x_0$ 指向 点 $x$ 的向量**为 $\mathbf{r}$，长度（也即点 $x$ 与超平面的距离）为 $r$。有两种方法计算可以计算出 $r$ 的大小：
...
\begin{cases}
	a_i\ge 0;\\
	y_if(\mathbf{x}_i)-1\ge 0;\\
	a_i(y_if(\mathbf{x}_i)-1)=0.\\
\end{cases}
$$
...
举个例子，二维平面上的“异或”问题不是线性可分的，但将其映射到三维空间就可以实现线性可分。如图：

![映射](https://img-blog.csdnimg.cn/20190807111538666.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl8zODMxMzExMw==,size_16,color_FFFFFF,t_70)
...
![overfitting](https://img-blog.csdnimg.cn/20190716233115719.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0F1Z3VzdE1l,size_16,color_FFFFFF,t_70)
...
不妨作图观察比较一下这些损失函数（code文件夹下有[实现代码](https://github.com/MartinXLiu/Learning-Note/blob/371bf8414387cbf086f6901609805f377c06d7e5/%E5%91%A8%E5%BF%97%E5%8D%8E-%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0%E8%A5%BF%E7%93%9C%E4%B9%A6/code/DrawLossFunction.py)）：

![loss function](https://github.com/MartinXLiu/Learning-Note/blob/8047af55ffe1b0cdaad439b29e15fd7e1a332a38/%E5%91%A8%E5%BF%97%E5%8D%8E-%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0%E8%A5%BF%E7%93%9C%E4%B9%A6/graph/LossFunction.png?raw=true)
...
该式描述的就是**软间隔支持向量机**，其中每个样本都对应着一个松弛变量，用以表示**该样本误分类的程度**，松弛变量的值越大，程度越高。
